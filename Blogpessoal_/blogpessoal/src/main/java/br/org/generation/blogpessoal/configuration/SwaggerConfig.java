...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal1").description("Projeto API Spring - Blog Pessoal1")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/maytech474")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Maicon Bonfim Izidoro", "https://github.com/maytech474", "maytech.bonfim@gmail.com");
	}
