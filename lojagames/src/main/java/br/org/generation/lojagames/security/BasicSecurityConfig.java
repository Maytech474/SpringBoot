...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private DaoAuthenticationConfigurer<AuthenticationManagerBuilder, UserDetailsService> userDetailsService2;

	@Override
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		userDetailsService2 = auth.userDetailsService(userDetailsService);
